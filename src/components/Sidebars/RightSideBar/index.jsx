...
export default function RightSideBar() {
	return (
		<div className="w-[300px] max-lg:w-0 max-lg:hidden h-screen">
			<aside className="fixed top-0 w-[300px] max-lg:w-0 max-lg:hidden h-screen overflow-y-auto px-4 pt-2 bg-white dark:bg-zinc-950 border-l border-r dark:border-zinc-800">
				<div>
