...
export default function Login() {
	return (
		<div className="w-full h-full flex items-center justify-center">
				...
				<div>
					...
					<div className="flex flex-col gap-4">
						...
						<div className="bg-gray-100 dark:bg-zinc-800 py-3 px-4 rounded-lg flex items-center gap-3 border border-transparent focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500">
							...
							/>
							<p className="font-semibold text-blue-600 dark:text-blue-400 text-xs cursor-pointer transition hover:underline rounded-lg hover:bg-zinc-700">
								Forgot?
							</p>
						</div>
					</div>
			...
			<div className="relative max-lg:hidden max-lg:w-0 max-lg:h-0 bg-blue-600 rounded-r-xl min-h-[500px] w-[300px] border-b border-t border-r border-gray-200 dark:border-zinc-800 shadow-lg">
			</div>
		</div>
	);
}
