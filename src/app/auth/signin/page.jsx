...
import { isValidEmail, isValidPassword, PASSWORD_MIN_LENGTH } from "@/shared/utils/validation/validation-util";
	    ...
	    <div className="flex items-stretch w-full max-lg:h-full justify-center">
				<div className="z-10 bg-white dark:bg-zinc-900 lg:rounded-l-xl lg:border-l lg:border-t lg:border-b lg:border-gray-200 lg:dark:border-zinc-800 lg:min-h-[500px] max-lg:h-full lg:w-[500px] max-lg:w-full lg:p-6 max-lg:p-10 shadow-lg flex flex-col">
					...
					<div className="text-center mb-6">
						...
						<h1 className="font-bold text-3xl text-gray-900 dark:text-white">Sign In</h1>
					</div>
					<div>
					...
					<div className="mt-6 flex justify-center">
						<button onClick={handleSignIn} className="bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition font-semibold w-full flex items-center justify-center gap-1">
							<p>Next</p>
							<MdOutlineArrowRight />
						</button>
					</div>
