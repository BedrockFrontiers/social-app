			...
			<div>
				...
				<div className="relative border-b dark:border-zinc-800 bg-white dark:bg-black">
						...
						<div className="flex max-[1000px]:flex-col gap-3">
							...
							<div className="mt-2 w-full">
								...
								<div className="flex mt-3 max-[1000px]:mt-10 gap-4">
									...
									<span className="text-gray-700 transition duration-200 hover:underline cursor-pointer dark:text-white text-sm"><strong>5.664</strong> posts</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="flex px-4 mt-10 flex-wrap gap-2 items-center mt-auto">
						...
						<p className="font-semibold select-none text-sm p-2 transition duration-200 hover:bg-gray-200 dark:hover:bg-zinc-700 cursor-pointer">Replies</p>
					</div>
				</div>
			</div>
		</MainStructure>
